...
_Stats as of 2026-07-15 00:07 UTC — last scan: 2026-07-14_
...
|--:|-----------|------:|-----------|
| 1 | jQuery | **34,709** | JavaScript libraries |
| 2 | PHP | **21,121** | Programming languages |
| 3 | Apache | **18,585** | Web servers |
| 4 | Bootstrap | **16,063** | UI frameworks |
| 5 | Font Awesome | **15,303** | Font scripts |
| 6 | Google Font API | **12,819** | Font scripts |
| 7 | MySQL | **11,912** | Databases |
| 8 | WordPress | **11,826** | Blogs, CMS |
| 9 | Nginx | **11,296** | Reverse proxies, Web servers |
| 10 | jQuery Migrate | **10,403** | JavaScript libraries |
| 11 | Windows Server | **5,891** | Operating systems |
| 12 | IIS | **5,803** | Web servers |
| 13 | jQuery UI | **5,785** | JavaScript libraries |
| 14 | Microsoft ASP.NET | **5,017** | Web frameworks |
| 15 | Google Tag Manager | **4,968** | Tag managers |
| 16 | Cloudflare | **4,891** | CDN |
| 17 | Drupal | **4,829** | CMS |
| 18 | jsDelivr | **4,672** | CDN |
| 19 | Yoast SEO | **3,830** | SEO |
...
| 2 | Web servers | **39,732** |
| 3 | Font scripts | **28,631** |
| 4 | Programming languages | **27,313** |
| 5 | CMS | **22,372** |
| 6 | UI frameworks | **21,308** |
| 7 | Databases | **12,459** |
| 8 | CDN | **12,449** |
| 9 | Blogs | **11,900** |
| 10 | Reverse proxies | **11,611** |
| 11 | Operating systems | **9,877** |
| 12 | Web frameworks | **8,026** |
| 13 | JavaScript frameworks | **6,621** |
| 14 | Miscellaneous | **5,167** |
| 15 | Tag managers | **5,000** |
