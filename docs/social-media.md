...
<desc id="pie-desc">Pie chart: social media tier distribution across 54,650 scanned pages. Legacy only: 15,382 (28.1%), Modern only: 231 (0.4%), Mixed: 3,014 (5.5%), No Social: 30,915 (56.6%)</desc>
<path d="M 120,110 L 120.000,20.000 A 90,90 0 0,1 203.579,143.386 Z" fill="#1a8cd8" stroke="#fff" stroke-width="1"><title>Twitter/X only: 15,382 (31.0%)</title></path>
<path d="M 120,110 L 203.579,143.386 A 90,90 0 0,1 202.565,145.819 Z" fill="#0085ff" stroke="#fff" stroke-width="1"><title>Modern only: 231 (0.5%)</title></path>
<path d="M 120,110 L 202.565,145.819 A 90,90 0 0,1 183.245,174.032 Z" fill="#7856ff" stroke="#fff" stroke-width="1"><title>Mixed: 3,014 (6.1%)</title></path>
<path d="M 120,110 L 183.245,174.032 A 90,90 0 1,1 120.000,20.000 Z" fill="#cccccc" stroke="#fff" stroke-width="1"><title>No Social: 30,915 (62.4%)</title></path>
...
_Stats as of 2026-08-25 09:43 UTC — last scan: 2026-08-25_

**75** scan batches run

**54,644** of **87,696** available pages scanned (**62.3%** coverage)
**49,536** of **54,644** scanned pages were reachable (**90.7%**)

**Legacy social media** (older, centralised platforms):

| Platform | Pages with link | % of scanned | % of reachable |
|----------|----------------|:------------:|:--------------:|
| 🐦 Twitter | **8,319** | 15.2% | 16.8% |
| ✖ X | **1,996** | 3.7% | 4.0% |
| 👍 Facebook | **16,106** | 29.5% | 32.5% |
| 💼 LinkedIn | **6,800** | 12.4% | 13.7% |
...
|----------|----------------|:------------:|:--------------:|
| 🦋 Bluesky | **626** | 1.1% | 1.3% |
| 🐘 Mastodon / Fediverse | **2,829** | 5.2% | 5.7% |
...
| 31 | Italy | 41.6% | 937 | 8 | 58.4% | 🥉 Growing |
...
| Italy | 2,718 | 5,351 | 2,270 | 41.6% | 937 | 1,154 | 1,075 | 65 | 1,238 | 257 | 8 | 171 | 0 | 179 | Aug 2026 |
...
| **Total** | **54,650** | **87,696** | **49,542** | **62.9%** | **30,915** | **15,382** | **8,325** | **2,002** | **16,112** | **6,800** | **231** | **3,014** | **626** | **2,829** | — |
