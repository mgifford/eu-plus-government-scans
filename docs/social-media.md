...
<desc id="pie-desc">Pie chart: social media tier distribution across 1,427 scanned pages. Legacy only: 496 (34.8%), Modern only: 4 (0.3%), Mixed: 91 (6.4%), No Social: 746 (52.3%)</desc>
<path d="M 120,110 L 120.000,20.000 A 90,90 0 0,1 185.227,172.012 Z" fill="#1a8cd8" stroke="#fff" stroke-width="1"><title>Twitter/X only: 496 (37.1%)</title></path>
<path d="M 120,110 L 185.227,172.012 A 90,90 0 0,1 184.050,173.227 Z" fill="#0085ff" stroke="#fff" stroke-width="1"><title>Modern only: 4 (0.3%)</title></path>
<path d="M 120,110 L 184.050,173.227 A 90,90 0 0,1 152.059,194.097 Z" fill="#7856ff" stroke="#fff" stroke-width="1"><title>Mixed: 91 (6.8%)</title></path>
<path d="M 120,110 L 152.059,194.097 A 90,90 0 1,1 120.000,20.000 Z" fill="#cccccc" stroke="#fff" stroke-width="1"><title>No Social: 746 (55.8%)</title></path>
<rect x="20" y="216" width="14" height="14" fill="#1a8cd8"/>
<text x="40" y="227" font-size="11" font-family="sans-serif" fill="#333">Twitter/X only (37.1%)</text>
...
<text x="40" y="293" font-size="11" font-family="sans-serif" fill="#333">No Social (55.8%)</text>
</svg>
<p style="text-align:center;font-size:0.75em;margin:0.3rem 0 0;color:#555;font-style:italic;">Social media tier distribution</p>
</div>

_Stats as of 2026-08-06 11:38 UTC — last scan: 2026-08-06_

**2** scan batches run

**1,427** of **87,696** available pages scanned (**1.6%** coverage)
**1,337** of **1,427** scanned pages were reachable (**93.7%**)
...
| 🐦 Twitter | **106** | 7.4% | 7.9% |
| ✖ X | **59** | 4.1% | 4.4% |
| 👍 Facebook | **560** | 39.2% | 41.9% |
| 💼 LinkedIn | **341** | 23.9% | 25.5% |
...
|------|---------|:-----------------:|:---------:|:-----------:|:---------------:|------|
| 1 | Belgium | 58.7% | 322 | 2 | 41.3% | 🥉 Growing |
...
| Belgium | 605 | 1,329 | 552 | 58.7% | 322 | 184 | 74 | 39 | 210 | 157 | 2 | 44 | 6 | 40 | Aug 2026 |
| **Total** | **1,427** | **87,696** | **1,337** | **56.1%** | **746** | **496** | **106** | **59** | **560** | **341** | **4** | **91** | **22** | **84** | — |
