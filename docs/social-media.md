...
_Stats as of 2026-03-22 22:57 UTC — last scan: 2026-03-22_

**20** scan batches run &nbsp;|&nbsp; **2,978** sites crawled so far
...
| ✖ X | **389** |
| 🦋 Bluesky | **172** |
| 🐘 Mastodon / Fediverse | **654** |

**10,754** of **2,978** pages were reachable (361.1% reachable rate).
