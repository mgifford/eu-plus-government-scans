...
_Stats as of 2026-03-22 13:59 UTC — last scan: 2026-03-22_

**15** scan batches run &nbsp;|&nbsp; **2,963** sites crawled so far
...
| ✖ X | **291** |
| 🦋 Bluesky | **129** |
| 🐘 Mastodon / Fediverse | **485** |

**7,983** of **2,963** pages were reachable (269.4% reachable rate).
