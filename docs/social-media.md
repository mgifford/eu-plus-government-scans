...
<desc id="pie-desc">Pie chart: social media tier distribution across 1,257 scanned pages. Legacy only: 446 (35.5%), Modern only: 4 (0.3%), Mixed: 80 (6.4%), No Social: 651 (51.8%)</desc>
<path d="M 120,110 L 120.000,20.000 A 90,90 0 0,1 182.573,174.689 Z" fill="#1a8cd8" stroke="#fff" stroke-width="1"><title>Twitter/X only: 446 (37.8%)</title></path>
<path d="M 120,110 L 182.573,174.689 A 90,90 0 0,1 181.182,176.006 Z" fill="#0085ff" stroke="#fff" stroke-width="1"><title>Modern only: 4 (0.3%)</title></path>
<path d="M 120,110 L 181.182,176.006 A 90,90 0 0,1 148.471,195.378 Z" fill="#7856ff" stroke="#fff" stroke-width="1"><title>Mixed: 80 (6.8%)</title></path>
<path d="M 120,110 L 148.471,195.378 A 90,90 0 1,1 120.000,20.000 Z" fill="#cccccc" stroke="#fff" stroke-width="1"><title>No Social: 651 (55.1%)</title></path>
<rect x="20" y="216" width="14" height="14" fill="#1a8cd8"/>
<text x="40" y="227" font-size="11" font-family="sans-serif" fill="#333">Twitter/X only (37.8%)</text>
...
<text x="40" y="293" font-size="11" font-family="sans-serif" fill="#333">No Social (55.1%)</text>
</svg>
<p style="text-align:center;font-size:0.75em;margin:0.3rem 0 0;color:#555;font-style:italic;">Social media tier distribution</p>
</div>

_Stats as of 2026-08-05 11:34 UTC — last scan: 2026-08-05_

**2** scan batches run

**1,257** of **87,696** available pages scanned (**1.4%** coverage)
**1,181** of **1,257** scanned pages were reachable (**94.0%**)
...
| 🐦 Twitter | **78** | 6.2% | 6.6% |
| ✖ X | **57** | 4.5% | 4.8% |
| 👍 Facebook | **504** | 40.1% | 42.7% |
| 💼 LinkedIn | **300** | 23.9% | 25.4% |
...
|------|---------|:-----------------:|:---------:|:-----------:|:---------------:|------|
| 1 | Belgium | 57.6% | 225 | 2 | 42.4% | 🥉 Growing |
...
| Belgium | 435 | 1,329 | 394 | 57.6% | 225 | 134 | 46 | 37 | 154 | 116 | 2 | 33 | 4 | 31 | Aug 2026 |
| **Total** | **1,257** | **87,696** | **1,181** | **55.5%** | **651** | **446** | **78** | **57** | **504** | **300** | **4** | **80** | **20** | **75** | — |
