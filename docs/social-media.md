...
_Stats as of 2026-03-23 05:45 UTC — last scan: 2026-03-23_

**25** scan batches run &nbsp;|&nbsp; **2,978** sites crawled so far
...
| ✖ X | **486** |
| 🦋 Bluesky | **215** |
| 🐘 Mastodon / Fediverse | **810** |

**13,382** of **2,978** pages were reachable (449.4% reachable rate).
