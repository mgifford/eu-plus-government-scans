...
_Stats as of 2026-03-21 16:38 UTC — last scan: 2026-03-21_

**5** scan batches run &nbsp;|&nbsp; **2,961** sites crawled so far
...
| ✖ X | **97** |
| 🦋 Bluesky | **43** |
| 🐘 Mastodon / Fediverse | **172** |

**2,776** of **2,961** pages were reachable (93.8% reachable rate).
