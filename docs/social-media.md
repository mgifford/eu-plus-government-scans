...
_Stats as of 2026-03-22 16:56 UTC — last scan: 2026-03-22_

**15** scan batches run &nbsp;|&nbsp; **2,978** sites crawled so far
...
| ✖ X | **292** |
| 🦋 Bluesky | **129** |
| 🐘 Mastodon / Fediverse | **502** |

**8,160** of **2,978** pages were reachable (274.0% reachable rate).
