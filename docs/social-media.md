...
_Stats as of 2026-03-21 22:58 UTC — last scan: 2026-03-21_

**5** scan batches run &nbsp;|&nbsp; **2,832** sites crawled so far
...
| ✖ X | **97** |
| 🦋 Bluesky | **43** |
| 🐘 Mastodon / Fediverse | **161** |

**2,640** of **2,832** pages were reachable (93.2% reachable rate).
