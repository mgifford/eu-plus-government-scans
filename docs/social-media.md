...
_Stats as of 2026-03-22 02:26 UTC — last scan: 2026-03-22_

**5** scan batches run &nbsp;|&nbsp; **2,756** sites crawled so far
...
| ✖ X | **97** |
| 🦋 Bluesky | **43** |
| 🐘 Mastodon / Fediverse | **159** |

**2,597** of **2,756** pages were reachable (94.2% reachable rate).
