...
_Progress as of 2026-08-11 20:06 UTC_

| Scan Type | Pages Scanned | Coverage | Avg Age |
|-----------|--------------|----------|---------|
| **Combined Reachability** | **3,989 confirmed reachable** | **<span role="img" aria-label="4.5% complete" class="sm-bar"><span class="sm-bar__track" style="width:120px;"><span class="sm-bar__fill sm-bar__fill--red" style="width:5px;"></span></span><span class="sm-bar__label">4.5%</span></span>** | — |
| Social Media | 3,584 scanned (3,324 reachable) | <span role="img" aria-label="4.1% complete" class="sm-bar"><span class="sm-bar__track" style="width:120px;"><span class="sm-bar__fill sm-bar__fill--red" style="width:5px;"></span></span><span class="sm-bar__label">4.1%</span></span> | 2 h |
| Lighthouse | 11,596 scanned | <span role="img" aria-label="13.2% complete" class="sm-bar"><span class="sm-bar__track" style="width:120px;"><span class="sm-bar__fill sm-bar__fill--red" style="width:16px;"></span></span><span class="sm-bar__label">13.2%</span></span> | 13.4 days |

**32 countries** with scan data · **3,989** of **87,696** available pages confirmed reachable. See the [Scan Progress Report](scan-progress.md) for full details.
