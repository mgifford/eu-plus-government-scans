...
_Progress as of 2026-08-29 14:54 UTC_

| Scan Type | Pages Scanned | Coverage | Avg Age |
|-----------|--------------|----------|---------|
| **Combined Reachability** | **57,510 confirmed reachable** | **<span role="img" aria-label="65.6% complete" class="sm-bar"><span class="sm-bar__track" style="width:120px;"><span class="sm-bar__fill sm-bar__fill--amber" style="width:79px;"></span></span><span class="sm-bar__label">65.6%</span></span>** | — |
| Social Media | 63,543 scanned (57,409 reachable) | <span role="img" aria-label="72.5% complete" class="sm-bar"><span class="sm-bar__track" style="width:120px;"><span class="sm-bar__fill sm-bar__fill--green" style="width:87px;"></span></span><span class="sm-bar__label">72.5%</span></span> | 10.4 days |
| Technology | 71,595 scanned | <span role="img" aria-label="81.6% complete" class="sm-bar"><span class="sm-bar__track" style="width:120px;"><span class="sm-bar__fill sm-bar__fill--green" style="width:98px;"></span></span><span class="sm-bar__label">81.6%</span></span> | 10.1 days |
...
| Accessibility Statements | 60,210 scanned | <span role="img" aria-label="68.7% complete" class="sm-bar"><span class="sm-bar__track" style="width:120px;"><span class="sm-bar__fill sm-bar__fill--green" style="width:82px;"></span></span><span class="sm-bar__label">68.7%</span></span> | 10.0 days |

**32 countries** with scan data · **57,510** of **87,696** available pages confirmed reachable. See the [Scan Progress Report](scan-progress.md) for full details.
