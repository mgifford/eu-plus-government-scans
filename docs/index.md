...
_Progress as of 2026-08-13 19:35 UTC_

| Scan Type | Pages Scanned | Coverage | Avg Age |
|-----------|--------------|----------|---------|
| **Combined Reachability** | **10,580 confirmed reachable** | **<span role="img" aria-label="12.1% complete" class="sm-bar"><span class="sm-bar__track" style="width:120px;"><span class="sm-bar__fill sm-bar__fill--red" style="width:14px;"></span></span><span class="sm-bar__label">12.1%</span></span>** | — |
| Social Media | 8,812 scanned (8,247 reachable) | <span role="img" aria-label="10.0% complete" class="sm-bar"><span class="sm-bar__track" style="width:120px;"><span class="sm-bar__fill sm-bar__fill--red" style="width:12px;"></span></span><span class="sm-bar__label">10.0%</span></span> | 1.1 days |
| Technology | 11,198 scanned | <span role="img" aria-label="12.8% complete" class="sm-bar"><span class="sm-bar__track" style="width:120px;"><span class="sm-bar__fill sm-bar__fill--red" style="width:15px;"></span></span><span class="sm-bar__label">12.8%</span></span> | 1.0 days |
| Lighthouse | 12,144 scanned | <span role="img" aria-label="13.8% complete" class="sm-bar"><span class="sm-bar__track" style="width:120px;"><span class="sm-bar__fill sm-bar__fill--red" style="width:17px;"></span></span><span class="sm-bar__label">13.8%</span></span> | 14.3 days |
| Accessibility Statements | 15,011 scanned | <span role="img" aria-label="17.1% complete" class="sm-bar"><span class="sm-bar__track" style="width:120px;"><span class="sm-bar__fill sm-bar__fill--red" style="width:21px;"></span></span><span class="sm-bar__label">17.1%</span></span> | 1.2 days |

**32 countries** with scan data · **10,580** of **87,696** available pages confirmed reachable. See the [Scan Progress Report](scan-progress.md) for full details.
