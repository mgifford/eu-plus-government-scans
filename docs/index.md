...
_Progress as of 2026-08-25 13:11 UTC_

| Scan Type | Pages Scanned | Coverage | Avg Age |
|-----------|--------------|----------|---------|
| **Combined Reachability** | **49,643 confirmed reachable** | **<span role="img" aria-label="56.6% complete" class="sm-bar"><span class="sm-bar__track" style="width:120px;"><span class="sm-bar__fill sm-bar__fill--amber" style="width:68px;"></span></span><span class="sm-bar__label">56.6%</span></span>** | — |
| Social Media | 54,650 scanned (49,542 reachable) | <span role="img" aria-label="62.3% complete" class="sm-bar"><span class="sm-bar__track" style="width:120px;"><span class="sm-bar__fill sm-bar__fill--amber" style="width:75px;"></span></span><span class="sm-bar__label">62.3%</span></span> | 7.7 days |
| Technology | 59,881 scanned | <span role="img" aria-label="68.3% complete" class="sm-bar"><span class="sm-bar__track" style="width:120px;"><span class="sm-bar__fill sm-bar__fill--green" style="width:82px;"></span></span><span class="sm-bar__label">68.3%</span></span> | 7.6 days |
...
| Accessibility Statements | 55,144 scanned | <span role="img" aria-label="62.9% complete" class="sm-bar"><span class="sm-bar__track" style="width:120px;"><span class="sm-bar__fill sm-bar__fill--amber" style="width:75px;"></span></span><span class="sm-bar__label">62.9%</span></span> | 7.2 days |

**32 countries** with scan data · **49,643** of **87,696** available pages confirmed reachable. See the [Scan Progress Report](scan-progress.md) for full details.
