...
_Progress as of 2026-07-22 00:52 UTC_

| Scan Type | Pages Scanned | Coverage | Avg Age |
|-----------|--------------|----------|---------|
| **Combined Reachability** | **27,157 confirmed reachable** | **<span role="img" aria-label="31.0% complete" class="sm-bar"><span class="sm-bar__track" style="width:120px;"><span class="sm-bar__fill sm-bar__fill--red" style="width:37px;"></span></span><span class="sm-bar__label">31.0%</span></span>** | — |
| Social Media | 30,054 scanned (27,146 reachable) | <span role="img" aria-label="34.3% complete" class="sm-bar"><span class="sm-bar__track" style="width:120px;"><span class="sm-bar__fill sm-bar__fill--amber" style="width:41px;"></span></span><span class="sm-bar__label">34.3%</span></span> | 1.0 days |
| Technology | 2,516 scanned | <span role="img" aria-label="2.9% complete" class="sm-bar"><span class="sm-bar__track" style="width:120px;"><span class="sm-bar__fill sm-bar__fill--red" style="width:3px;"></span></span><span class="sm-bar__label">2.9%</span></span> | 19 h |
| Accessibility Statements | 8,145 scanned | <span role="img" aria-label="9.3% complete" class="sm-bar"><span class="sm-bar__track" style="width:120px;"><span class="sm-bar__fill sm-bar__fill--red" style="width:11px;"></span></span><span class="sm-bar__label">9.3%</span></span> | 23 h |

**32 countries** with scan data · **27,157** of **87,696** available pages confirmed reachable. See the [Scan Progress Report](scan-progress.md) for full details.
