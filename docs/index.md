...
_Progress as of 2026-07-22 19:28 UTC_
...
| Lighthouse | 3,342 scanned | <span role="img" aria-label="3.8% complete" class="sm-bar"><span class="sm-bar__track" style="width:120px;"><span class="sm-bar__fill sm-bar__fill--red" style="width:5px;"></span></span><span class="sm-bar__label">3.8%</span></span> | 1.4 days |

**19 countries** with scan data · **0** of **87,696** available pages confirmed reachable. See the [Scan Progress Report](scan-progress.md) for full details.
