...
_Progress as of 2026-08-01 01:39 UTC_
...
| Lighthouse | 8,534 scanned | <span role="img" aria-label="9.7% complete" class="sm-bar"><span class="sm-bar__track" style="width:120px;"><span class="sm-bar__fill sm-bar__fill--red" style="width:12px;"></span></span><span class="sm-bar__label">9.7%</span></span> | 6.9 days |

**28 countries** with scan data · **0** of **87,696** available pages confirmed reachable. See the [Scan Progress Report](scan-progress.md) for full details.
