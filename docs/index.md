...
_Progress as of 2026-07-22 23:22 UTC_

| Scan Type | Pages Scanned | Coverage | Avg Age |
|-----------|--------------|----------|---------|
| **Combined Reachability** | **41,982 confirmed reachable** | **<span role="img" aria-label="47.9% complete" class="sm-bar"><span class="sm-bar__track" style="width:120px;"><span class="sm-bar__fill sm-bar__fill--amber" style="width:57px;"></span></span><span class="sm-bar__label">47.9%</span></span>** | — |
| Social Media | 46,371 scanned (41,971 reachable) | <span role="img" aria-label="52.9% complete" class="sm-bar"><span class="sm-bar__track" style="width:120px;"><span class="sm-bar__fill sm-bar__fill--amber" style="width:63px;"></span></span><span class="sm-bar__label">52.9%</span></span> | 1.5 days |
| Technology | 3,749 scanned | <span role="img" aria-label="4.3% complete" class="sm-bar"><span class="sm-bar__track" style="width:120px;"><span class="sm-bar__fill sm-bar__fill--red" style="width:5px;"></span></span><span class="sm-bar__label">4.3%</span></span> | 1.3 days |
| Accessibility Statements | 13,297 scanned | <span role="img" aria-label="15.2% complete" class="sm-bar"><span class="sm-bar__track" style="width:120px;"><span class="sm-bar__fill sm-bar__fill--red" style="width:18px;"></span></span><span class="sm-bar__label">15.2%</span></span> | 1.3 days |

**32 countries** with scan data · **41,982** of **87,696** available pages confirmed reachable. See the [Scan Progress Report](scan-progress.md) for full details.
