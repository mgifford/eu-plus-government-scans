...
_Progress as of 2026-08-08 03:21 UTC_

| Scan Type | Pages Scanned | Coverage | Avg Age |
|-----------|--------------|----------|---------|
| **Combined Reachability** | **4,555 confirmed reachable** | **<span role="img" aria-label="5.2% complete" class="sm-bar"><span class="sm-bar__track" style="width:120px;"><span class="sm-bar__fill sm-bar__fill--red" style="width:6px;"></span></span><span class="sm-bar__label">5.2%</span></span>** | — |
...
| Technology | 3,795 scanned | <span role="img" aria-label="4.3% complete" class="sm-bar"><span class="sm-bar__track" style="width:120px;"><span class="sm-bar__fill sm-bar__fill--red" style="width:5px;"></span></span><span class="sm-bar__label">4.3%</span></span> | 11 h |
...
| Accessibility Statements | 10,827 scanned | <span role="img" aria-label="12.3% complete" class="sm-bar"><span class="sm-bar__track" style="width:120px;"><span class="sm-bar__fill sm-bar__fill--red" style="width:15px;"></span></span><span class="sm-bar__label">12.3%</span></span> | 21 h |

**32 countries** with scan data · **4,555** of **87,696** available pages confirmed reachable. See the [Scan Progress Report](scan-progress.md) for full details.
