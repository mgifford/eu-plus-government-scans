...
_Progress as of 2026-09-02 11:04 UTC_

| Scan Type | Pages Scanned | Coverage | Avg Age |
|-----------|--------------|----------|---------|
| **Combined Reachability** | **68,951 confirmed reachable** | **<span role="img" aria-label="78.6% complete" class="sm-bar"><span class="sm-bar__track" style="width:120px;"><span class="sm-bar__fill sm-bar__fill--green" style="width:94px;"></span></span><span class="sm-bar__label">78.6%</span></span>** | — |
| Social Media | 76,218 scanned (68,850 reachable) | <span role="img" aria-label="86.9% complete" class="sm-bar"><span class="sm-bar__track" style="width:120px;"><span class="sm-bar__fill sm-bar__fill--green" style="width:104px;"></span></span><span class="sm-bar__label">86.9%</span></span> | 12.2 days |
| Technology | 87,696 scanned | <span role="img" aria-label="100.0% complete" class="sm-bar"><span class="sm-bar__track" style="width:120px;"><span class="sm-bar__fill sm-bar__fill--green" style="width:120px;"></span></span><span class="sm-bar__label">100.0%</span></span> | 11.8 days |
...
| Accessibility Statements | 72,451 scanned | <span role="img" aria-label="82.6% complete" class="sm-bar"><span class="sm-bar__track" style="width:120px;"><span class="sm-bar__fill sm-bar__fill--green" style="width:99px;"></span></span><span class="sm-bar__label">82.6%</span></span> | 12.6 days |

**32 countries** with scan data · **68,951** of **87,696** available pages confirmed reachable. See the [Scan Progress Report](scan-progress.md) for full details.
