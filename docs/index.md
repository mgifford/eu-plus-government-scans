...
_Progress as of 2026-08-09 02:53 UTC_

| Scan Type | Pages Scanned | Coverage | Avg Age |
|-----------|--------------|----------|---------|
| **Combined Reachability** | **9,433 confirmed reachable** | **<span role="img" aria-label="10.8% complete" class="sm-bar"><span class="sm-bar__track" style="width:120px;"><span class="sm-bar__fill sm-bar__fill--red" style="width:13px;"></span></span><span class="sm-bar__label">10.8%</span></span>** | — |
| Social Media | 2,876 scanned (2,683 reachable) | <span role="img" aria-label="3.3% complete" class="sm-bar"><span class="sm-bar__track" style="width:120px;"><span class="sm-bar__fill sm-bar__fill--red" style="width:4px;"></span></span><span class="sm-bar__label">3.3%</span></span> | 11 h |
...
**32 countries** with scan data · **9,433** of **87,696** available pages confirmed reachable. See the [Scan Progress Report](scan-progress.md) for full details.
