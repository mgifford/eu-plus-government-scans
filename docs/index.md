...
_Progress as of 2026-07-31 13:46 UTC_
...
| Lighthouse | 8,376 scanned | <span role="img" aria-label="9.6% complete" class="sm-bar"><span class="sm-bar__track" style="width:120px;"><span class="sm-bar__fill sm-bar__fill--red" style="width:11px;"></span></span><span class="sm-bar__label">9.6%</span></span> | 6.6 days |

**27 countries** with scan data · **0** of **87,696** available pages confirmed reachable. See the [Scan Progress Report](scan-progress.md) for full details.
