...
_Progress as of 2026-08-16 02:57 UTC_

| Scan Type | Pages Scanned | Coverage | Avg Age |
|-----------|--------------|----------|---------|
| **Combined Reachability** | **24,311 confirmed reachable** | **<span role="img" aria-label="27.7% complete" class="sm-bar"><span class="sm-bar__track" style="width:120px;"><span class="sm-bar__fill sm-bar__fill--red" style="width:33px;"></span></span><span class="sm-bar__label">27.7%</span></span>** | — |
| Social Media | 24,788 scanned (22,719 reachable) | <span role="img" aria-label="28.3% complete" class="sm-bar"><span class="sm-bar__track" style="width:120px;"><span class="sm-bar__fill sm-bar__fill--red" style="width:34px;"></span></span><span class="sm-bar__label">28.3%</span></span> | 1.9 days |
...
| Lighthouse | 12,456 scanned | <span role="img" aria-label="14.2% complete" class="sm-bar"><span class="sm-bar__track" style="width:120px;"><span class="sm-bar__fill sm-bar__fill--red" style="width:17px;"></span></span><span class="sm-bar__label">14.2%</span></span> | 15.7 days |
| Accessibility Statements | 32,442 scanned | <span role="img" aria-label="37.0% complete" class="sm-bar"><span class="sm-bar__track" style="width:120px;"><span class="sm-bar__fill sm-bar__fill--amber" style="width:44px;"></span></span><span class="sm-bar__label">37.0%</span></span> | 2.2 days |

**32 countries** with scan data · **24,311** of **87,696** available pages confirmed reachable. See the [Scan Progress Report](scan-progress.md) for full details.
