...
_Progress as of 2026-07-28 15:38 UTC_

| Scan Type | Pages Scanned | Coverage | Avg Age |
|-----------|--------------|----------|---------|
| **Combined Reachability** | **79,998 confirmed reachable** | **<span role="img" aria-label="91.2% complete" class="sm-bar"><span class="sm-bar__track" style="width:120px;"><span class="sm-bar__fill sm-bar__fill--green" style="width:109px;"></span></span><span class="sm-bar__label">91.2%</span></span>** | — |
| Social Media | 87,696 scanned (79,997 reachable) | <span role="img" aria-label="100.0% complete" class="sm-bar"><span class="sm-bar__track" style="width:120px;"><span class="sm-bar__fill sm-bar__fill--green" style="width:120px;"></span></span><span class="sm-bar__label">100.0%</span></span> | 4.9 days |
| Technology | 16,377 scanned | <span role="img" aria-label="18.7% complete" class="sm-bar"><span class="sm-bar__track" style="width:120px;"><span class="sm-bar__fill sm-bar__fill--red" style="width:22px;"></span></span><span class="sm-bar__label">18.7%</span></span> | 3.5 days |
| Accessibility Statements | 34,589 scanned | <span role="img" aria-label="39.4% complete" class="sm-bar"><span class="sm-bar__track" style="width:120px;"><span class="sm-bar__fill sm-bar__fill--amber" style="width:47px;"></span></span><span class="sm-bar__label">39.4%</span></span> | 4.2 days |

**32 countries** with scan data · **79,998** of **87,696** available pages confirmed reachable. See the [Scan Progress Report](scan-progress.md) for full details.
