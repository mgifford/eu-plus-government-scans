...
_Progress as of 2026-07-22 14:56 UTC_

| Scan Type | Pages Scanned | Coverage | Avg Age |
|-----------|--------------|----------|---------|
| **Combined Reachability** | **37,840 confirmed reachable** | **<span role="img" aria-label="43.1% complete" class="sm-bar"><span class="sm-bar__track" style="width:120px;"><span class="sm-bar__fill sm-bar__fill--amber" style="width:52px;"></span></span><span class="sm-bar__label">43.1%</span></span>** | — |
| Social Media | 41,025 scanned (37,469 reachable) | <span role="img" aria-label="46.8% complete" class="sm-bar"><span class="sm-bar__track" style="width:120px;"><span class="sm-bar__fill sm-bar__fill--amber" style="width:56px;"></span></span><span class="sm-bar__label">46.8%</span></span> | 1.3 days |
...
**32 countries** with scan data · **37,840** of **87,696** available pages confirmed reachable. See the [Scan Progress Report](scan-progress.md) for full details.
