...
_Progress as of 2026-08-24 08:03 UTC_

| Scan Type | Pages Scanned | Coverage | Avg Age |
|-----------|--------------|----------|---------|
| **Combined Reachability** | **45,338 confirmed reachable** | **<span role="img" aria-label="51.7% complete" class="sm-bar"><span class="sm-bar__track" style="width:120px;"><span class="sm-bar__fill sm-bar__fill--amber" style="width:62px;"></span></span><span class="sm-bar__label">51.7%</span></span>** | — |
| Social Media | 50,037 scanned (45,237 reachable) | <span role="img" aria-label="57.1% complete" class="sm-bar"><span class="sm-bar__track" style="width:120px;"><span class="sm-bar__fill sm-bar__fill--amber" style="width:68px;"></span></span><span class="sm-bar__label">57.1%</span></span> | 7.1 days |
| Technology | 55,187 scanned | <span role="img" aria-label="62.9% complete" class="sm-bar"><span class="sm-bar__track" style="width:120px;"><span class="sm-bar__fill sm-bar__fill--amber" style="width:76px;"></span></span><span class="sm-bar__label">62.9%</span></span> | 7.0 days |
...
| Accessibility Statements | 54,975 scanned | <span role="img" aria-label="62.7% complete" class="sm-bar"><span class="sm-bar__track" style="width:120px;"><span class="sm-bar__fill sm-bar__fill--amber" style="width:75px;"></span></span><span class="sm-bar__label">62.7%</span></span> | 6.5 days |

**32 countries** with scan data · **45,338** of **87,696** available pages confirmed reachable. See the [Scan Progress Report](scan-progress.md) for full details.
