...
**55,993** of **87,696** available pages scanned (**63.8%** coverage)
**51,295** of **55,993** scanned pages were reachable (**91.6%**)
**23,504** of **51,295** reachable pages have an accessibility statement (**45.8%**)
**20,769** pages have the statement link in the footer (**88.4%** of pages with a statement)
...
| **Total** | **55,999** | **87,696** | **51,301** | **23,510** | **20,775** | **45.8%** | — |
