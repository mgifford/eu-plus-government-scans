...
**51,885** of **82,714** available pages scanned (**62.7%** coverage)
**47,919** of **51,885** scanned pages were reachable (**92.4%**)
**23,148** of **47,919** reachable pages have an accessibility statement (**48.3%**)
**20,460** pages have the statement link in the footer (**88.4%** of pages with a statement)
...
| **Total** | **51,885** | **82,714** | **47,919** | **23,148** | **20,460** | **48.3%** | — |
