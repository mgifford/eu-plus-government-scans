...
_Stats as of 2026-09-21 06:16 UTC — last scan: 2026-09-21_

**232** scan batches run

**87,690** of **87,696** available pages scanned (**100.0%** coverage)
**80,321** of **87,690** scanned pages were reachable (**91.6%**)
**39,231** of **80,321** reachable pages have an accessibility statement (**48.8%**)
**34,368** pages have the statement link in the footer (**87.6%** of pages with a statement)
...
| **Total** | **87,696** | **87,696** | **80,327** | **39,237** | **34,374** | **48.8%** | — |
