...
_Stats as of 2026-03-30 15:02 UTC — last scan: 2026-03-30_

**45** scan batches run

**52,276** of **82,714** available pages scanned (**63.2%** coverage)
**48,299** of **52,276** scanned pages were reachable (**92.4%**)
**23,401** of **48,299** reachable pages have an accessibility statement (**48.5%**)
**20,647** pages have the statement link in the footer (**88.2%** of pages with a statement)
...
| POLAND | 7,403 | 14,938 | 6,796 | 2,823 | 1,898 | 41.5% | Mar 2026 |
...
| **Total** | **52,276** | **82,714** | **48,299** | **23,401** | **20,647** | **48.5%** | — |
