...
_Stats as of 2026-07-19 22:33 UTC — last scan: 2026-07-19_

**9** scan batches run

**4,770** of **83,227** available pages scanned (**5.7%** coverage)
**4,386** of **4,770** scanned pages were reachable (**91.9%**)
**2,071** reachable pages loaded at least one third-party script (**47.2%** of reachable)
**3,339** known third-party service loads identified
**20** unique known services across **13** categories
...
| Denmark | 1,467 | 1,536 | 1,436 | 784 | 2,016 | 54.6 | 140.4 | 2026-07-19 |
| Estonia | 396 | 401 | 352 | 112 | 94 | 31.8 | 26.7 | 2026-07-19 |
| Finland | 199 | 199 | 188 | 46 | 26 | 24.5 | 13.8 | 2026-07-19 |
...
| # | Service | Loads |
|--:|---------|------:|
| 1 | cdnjs (Cloudflare CDN) | **1,384** |
| 2 | CookieInformation | **394** |
| 3 | Google Analytics (GA4) | **283** |
| 4 | jsDelivr CDN | **245** |
| 5 | Cookiebot | **208** |
| 6 | Google Hosted Libraries | **165** |
| 7 | Google reCAPTCHA | **157** |
| 8 | unpkg CDN | **156** |
| 9 | Google Tag Manager | **121** |
| 10 | jQuery | **111** |
| 11 | Font Awesome | **31** |
| 12 | OneTrust | **30** |
| 13 | Facebook Pixel | **22** |
| 14 | Bootstrap | **14** |
| 15 | Sentry | **5** |
| 16 | Matomo Cloud | **4** |
| 17 | Google Analytics (Universal) | **4** |
| 18 | Cloudflare Turnstile / Challenge | **2** |
| 19 | Zendesk | **2** |
| 20 | Adobe Dynamic Tag Management / Launch | **1** |

### Top Services by Page Prevalence

| # | Service | Reachable Pages | Prevalence of Reachable Pages |
|--:|---------|----------------:|------------------------------:|
| 1 | CookieInformation | **394** | **193.1%** |
| 2 | cdnjs (Cloudflare CDN) | **370** | **181.4%** |
| 3 | Google Analytics (GA4) | **281** | **137.7%** |
| 4 | Cookiebot | **208** | **102.0%** |
| 5 | Google Hosted Libraries | **155** | **76.0%** |
| 6 | Google reCAPTCHA | **155** | **76.0%** |
| 7 | jsDelivr CDN | **153** | **75.0%** |
| 8 | Google Tag Manager | **114** | **55.9%** |
| 9 | jQuery | **105** | **51.5%** |
| 10 | unpkg CDN | **86** | **42.2%** |
| 11 | OneTrust | **30** | **14.7%** |
| 12 | Font Awesome | **28** | **13.7%** |
| 13 | Facebook Pixel | **22** | **10.8%** |
| 14 | Bootstrap | **14** | **6.9%** |
| 15 | Sentry | **5** | **2.5%** |
| 16 | Google Analytics (Universal) | **4** | **2.0%** |
| 17 | Matomo Cloud | **4** | **2.0%** |
| 18 | Cloudflare Turnstile / Challenge | **2** | **1.0%** |
| 19 | Zendesk | **2** | **1.0%** |
| 20 | Adobe Dynamic Tag Management / Launch | **1** | **0.5%** |
...
|--:|----------|------:|
| 1 | CDN | **1,950** |
| 2 | Cookie Consent | **632** |
| 3 | Analytics | **314** |
| 4 | JavaScript Library | **276** |
| 5 | Security | **159** |
| 6 | CAPTCHA | **157** |
| 7 | Tag Manager | **122** |
| 8 | Icon Library | **31** |
...
|--:|------|------:|----------------:|
| 1 | `ajax.aspnetcdn.com` | **530** | **261** |
| 2 | `cdn.ent.auvergnerhonealpes.fr` | **452** | **45** |
| 3 | `customer.cludo.com` | **289** | **227** |
| 4 | `dreambroker.com` | **242** | **242** |
| 5 | `cdn.herning.dk` | **237** | **24** |
| 6 | `cookie-notice.plzen.eu` | **208** | **113** |
| 7 | `cdn.hjoerring.dk` | **188** | **17** |
| 8 | `cdn1.gopublic.dk` | **171** | **18** |
| 9 | `webcachex-eu.datareporter.eu` | **162** | **162** |
| 10 | `consent.cookiebot.eu` | **139** | **139** |
| 11 | `analytics.silktide.com` | **117** | **115** |
| 12 | `cdn.ecollege.haute-garonne.fr` | **97** | **10** |
| 13 | `siteimproveanalytics.com` | **96** | **96** |
| 14 | `app-script.monsido.com` | **80** | **80** |
| 15 | `prod.widgets.burgerprofiel.vlaanderen.be` | **57** | **17** |
