...
**21,171** of **23,043** scanned pages were reachable (**91.9%**)
**10,145** reachable pages loaded at least one third-party script (**47.9%** of reachable)
**13,559** known third-party service loads identified
...
| Malta | 608 | 608 | 590 | 453 | 1,237 | 76.8 | 209.7 | 2026-05-27 |
...
| # | Service | Loads |
|--:|---------|------:|
| 1 | jsDelivr CDN | **2,885** |
| 2 | cdnjs (Cloudflare CDN) | **2,572** |
| 3 | Google Analytics (GA4) | **1,961** |
| 4 | jQuery | **1,063** |
| 5 | Google reCAPTCHA | **1,018** |
| 6 | unpkg CDN | **872** |
| 7 | Google Tag Manager | **820** |
