...
_Stats as of 2026-06-01 07:51 UTC — last scan: 2026-05-31_

**44** scan batches run

**23,043** of **82,714** available pages scanned (**27.9%** coverage)
**21,154** of **23,043** scanned pages were reachable (**91.8%**)
**10,113** reachable pages loaded at least one third-party script (**47.8%** of reachable)
...
| 2 | jsDelivr CDN | **1,698** | **361.3%** |
| 3 | cdnjs (Cloudflare CDN) | **1,156** | **246.0%** |
| 4 | Google reCAPTCHA | **997** | **212.1%** |
| 5 | Google Tag Manager | **790** | **168.1%** |
| 6 | jQuery | **760** | **161.7%** |
| 7 | unpkg CDN | **630** | **134.0%** |
