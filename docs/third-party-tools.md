...
| # | Service | Loads |
|--:|---------|------:|
| 1 | Google Analytics (GA4) | **283** |
| 2 | jsDelivr CDN | **232** |
| 3 | Google Hosted Libraries | **156** |
| 4 | Google reCAPTCHA | **148** |
| 5 | cdnjs (Cloudflare CDN) | **119** |
| 6 | Google Tag Manager | **119** |
| 7 | jQuery | **96** |
| 8 | unpkg CDN | **44** |
| 9 | Font Awesome | **29** |
| 10 | Cookiebot | **24** |
| 11 | Facebook Pixel | **21** |
| 12 | Bootstrap | **14** |
| 13 | Matomo Cloud | **4** |
| 14 | Google Analytics (Universal) | **4** |
...
|--:|---------|----------------:|------------------------------:|
| 1 | Google Analytics (GA4) | **281** | **137.7%** |
| 2 | Google Hosted Libraries | **146** | **71.6%** |
| 3 | Google reCAPTCHA | **146** | **71.6%** |
| 4 | jsDelivr CDN | **144** | **70.6%** |
| 5 | Google Tag Manager | **112** | **54.9%** |
| 6 | cdnjs (Cloudflare CDN) | **103** | **50.5%** |
| 7 | jQuery | **94** | **46.1%** |
| 8 | unpkg CDN | **33** | **16.2%** |
| 9 | Font Awesome | **26** | **12.7%** |
| 10 | Cookiebot | **24** | **11.8%** |
| 11 | Facebook Pixel | **21** | **10.3%** |
| 12 | Bootstrap | **14** | **6.9%** |
| 13 | Google Analytics (Universal) | **4** | **2.0%** |
| 14 | Matomo Cloud | **4** | **2.0%** |
| 15 | Cloudflare Turnstile / Challenge | **2** | **1.0%** |
| 16 | Zendesk | **2** | **1.0%** |
...
| 2 | `cookie-notice.plzen.eu` | **208** | **113** |
| 3 | `webcachex-eu.datareporter.eu` | **162** | **162** |
| 4 | `cdn.ecollege.haute-garonne.fr` | **97** | **10** |
| 5 | `prod.widgets.burgerprofiel.vlaanderen.be` | **57** | **17** |
| 6 | `translate.google.com` | **47** | **47** |
| 7 | `hubcdn.arcgis.com` | **45** | **9** |
| 8 | `npmcdn.com` | **41** | **41** |
| 9 | `static.crisp.help` | **39** | **16** |
| 10 | `maps.googleapis.com` | **38** | **25** |
| 11 | `code.highcharts.com` | **36** | **36** |
| 12 | `s7.addthis.com` | **30** | **28** |
| 13 | `cdn.puxdesign.cz` | **28** | **4** |
| 14 | `content.powerapps.com` | **24** | **2** |
| 15 | `chettyconfigstorage.blob.core.windows.net` | **19** | **19** |
