...
_Stats as of 2026-05-29 15:54 UTC — last scan: 2026-05-29_

**31** scan batches run

**22,549** of **82,714** available pages scanned (**27.3%** coverage)
**20,663** of **22,549** scanned pages were reachable (**91.6%**)
**9,840** reachable pages loaded at least one third-party script (**47.6%** of reachable)
**13,235** known third-party service loads identified
...
| # | Service | Loads |
|--:|---------|------:|
| 1 | jsDelivr CDN | **2,832** |
| 2 | cdnjs (Cloudflare CDN) | **2,531** |
| 3 | Google Analytics (GA4) | **1,873** |
| 4 | jQuery | **1,045** |
...
|--:|---------|----------------:|------------------------------:|
| 1 | Google Analytics (GA4) | **1,836** | **317.1%** |
| 2 | jsDelivr CDN | **1,668** | **288.1%** |
