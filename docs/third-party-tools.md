...
_Stats as of 2026-05-31 19:25 UTC — last scan: 2026-05-31_

**41** scan batches run

**23,043** of **82,714** available pages scanned (**27.9%** coverage)
**21,141** of **23,043** scanned pages were reachable (**91.7%**)
**10,097** reachable pages loaded at least one third-party script (**47.8%** of reachable)
**13,545** known third-party service loads identified
...
| 2 | jsDelivr CDN | **1,681** | **357.7%** |
| 3 | cdnjs (Cloudflare CDN) | **1,156** | **246.0%** |
| 4 | Google reCAPTCHA | **1,001** | **213.0%** |
