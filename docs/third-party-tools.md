...
_Stats as of 2026-08-10 09:47 UTC — last scan: 2026-08-10_

**6** scan batches run

**2,765** of **87,696** available pages scanned (**3.2%** coverage)
**2,448** of **2,765** scanned pages were reachable (**88.5%**)
**1,035** reachable pages loaded at least one third-party script (**42.3%** of reachable)
**1,052** known third-party service loads identified
**16** unique known services across **12** categories
...
| Belgium | 344 | 1,329 | 215 | 112 | 116 | 52.1 | 54.0 | 2026-08-09 |
| Bulgaria | 353 | 353 | 300 | 122 | 153 | 40.7 | 51.0 | 2026-08-09 |
| Croatia | 257 | 257 | 253 | 124 | 175 | 49.0 | 69.2 | 2026-08-09 |
| Czechia | 589 | 866 | 523 | 272 | 445 | 52.0 | 85.1 | 2026-08-10 |
| Estonia | 401 | 401 | 380 | 132 | 113 | 34.7 | 29.7 | 2026-08-10 |
...
| # | Service | Loads |
|--:|---------|------:|
| 1 | Google Analytics (GA4) | **234** |
| 2 | jsDelivr CDN | **187** |
| 3 | cdnjs (Cloudflare CDN) | **121** |
| 4 | Google Hosted Libraries | **117** |
| 5 | Google reCAPTCHA | **115** |
| 6 | Google Tag Manager | **115** |
| 7 | jQuery | **62** |
| 8 | unpkg CDN | **27** |
| 9 | Font Awesome | **27** |
| 10 | Cookiebot | **17** |
| 11 | Facebook Pixel | **16** |
| 12 | Bootstrap | **8** |
| 13 | Cloudflare Turnstile / Challenge | **2** |
| 14 | Zendesk | **2** |
| 15 | Google Analytics (Universal) | **1** |
| 16 | Matomo Cloud | **1** |
...
|--:|---------|----------------:|------------------------------:|
| 1 | Google Analytics (GA4) | **232** | **61.1%** |
| 2 | Google Tag Manager | **115** | **30.3%** |
| 3 | Google reCAPTCHA | **113** | **29.7%** |
| 4 | Google Hosted Libraries | **108** | **28.4%** |
| 5 | jsDelivr CDN | **103** | **27.1%** |
| 6 | cdnjs (Cloudflare CDN) | **102** | **26.8%** |
| 7 | jQuery | **59** | **15.5%** |
| 8 | Font Awesome | **24** | **6.3%** |
| 9 | unpkg CDN | **20** | **5.3%** |
| 10 | Cookiebot | **17** | **4.5%** |
| 11 | Facebook Pixel | **16** | **4.2%** |
| 12 | Bootstrap | **8** | **2.1%** |
| 13 | Cloudflare Turnstile / Challenge | **2** | **0.5%** |
| 14 | Zendesk | **2** | **0.5%** |
| 15 | Google Analytics (Universal) | **1** | **0.3%** |
| 16 | Matomo Cloud | **1** | **0.3%** |
...
| 2 | `cookie-notice.plzen.eu` | **142** | **78** |
| 3 | `prod.widgets.burgerprofiel.vlaanderen.be` | **60** | **18** |
| 4 | `hubcdn.arcgis.com` | **45** | **9** |
| 5 | `npmcdn.com` | **38** | **38** |
| 6 | `translate.google.com` | **37** | **37** |
| 7 | `code.highcharts.com` | **33** | **33** |
| 8 | `s7.addthis.com` | **30** | **28** |
| 9 | `content.powerapps.com` | **24** | **2** |
| 10 | `static.addtoany.com` | **18** | **18** |
| 11 | `plausible.io` | **16** | **16** |
| 12 | `chettyconfigstorage.blob.core.windows.net` | **16** | **16** |
| 13 | `maps.googleapis.com` | **15** | **15** |
| 14 | `cdn-cookieyes.com` | **13** | **13** |
| 15 | `www.gstatic.com` | **11** | **11** |
