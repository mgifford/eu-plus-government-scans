...
_Stats as of 2026-05-24 16:37 UTC — last scan: 2026-05-24_

**6** scan batches run

**5,756** of **82,714** available pages scanned (**7.0%** coverage)
**5,451** of **5,756** scanned pages were reachable (**94.7%**)
**2,225** reachable pages loaded at least one third-party script (**40.8%** of reachable)
**1,987** known third-party service loads identified
...
| 1 | jsDelivr CDN | **779** |
| 2 | unpkg CDN | **348** |
| 3 | cdnjs (Cloudflare CDN) | **238** |
| 4 | Google Analytics (GA4) | **133** |
| 5 | Google reCAPTCHA | **86** |
| 6 | Google Hosted Libraries | **85** |
| 7 | jQuery | **73** |
| 8 | Google Tag Manager | **67** |
| 9 | Font Awesome | **50** |
| 10 | Cookiebot | **41** |
| 11 | Bootstrap | **38** |
| 12 | Matomo Cloud | **14** |
...
| 15 | Sentry | **5** |
| 16 | OneTrust | **4** |
| 17 | Adobe Dynamic Tag Management / Launch | **2** |
| 18 | Cloudflare Turnstile / Challenge | **2** |
| 19 | CookieInformation | **2** |
| 20 | HubSpot | **1** |
...
|--:|---------|----------------:|------------------------------:|
| 1 | jsDelivr CDN | **402** | **26.1%** |
| 2 | unpkg CDN | **283** | **18.4%** |
| 3 | cdnjs (Cloudflare CDN) | **162** | **10.5%** |
| 4 | Google Analytics (GA4) | **131** | **8.5%** |
| 5 | Google reCAPTCHA | **85** | **5.5%** |
| 6 | Google Hosted Libraries | **81** | **5.3%** |
| 7 | Google Tag Manager | **67** | **4.3%** |
| 8 | jQuery | **66** | **4.3%** |
| 9 | Font Awesome | **40** | **2.6%** |
| 10 | Bootstrap | **38** | **2.5%** |
| 11 | Cookiebot | **38** | **2.5%** |
| 12 | Matomo Cloud | **14** | **0.9%** |
| 13 | Usercentrics | **10** | **0.6%** |
| 14 | Facebook Pixel | **9** | **0.6%** |
| 15 | Sentry | **5** | **0.3%** |
| 16 | OneTrust | **4** | **0.3%** |
| 17 | Adobe Dynamic Tag Management / Launch | **2** | **0.1%** |
| 18 | Cloudflare Turnstile / Challenge | **2** | **0.1%** |
| 19 | CookieInformation | **2** | **0.1%** |
| 20 | HubSpot | **1** | **0.1%** |
...
| 3 | `prod.widgets.burgerprofiel.vlaanderen.be` | **177** | **57** |
| 4 | `webcachex-eu.datareporter.eu` | **164** | **164** |
| 5 | `www.berlin.de` | **83** | **34** |
| 6 | `cdn.eye-able.com` | **78** | **39** |
| 7 | `login.eduport.hamburg.de` | **54** | **54** |
| 8 | `content.powerapps.com` | **48** | **4** |
| 9 | `translate.google.com` | **46** | **46** |
| 10 | `cartographie-prod-app-static-assets.s3.fr-par.scw.cloud` | **44** | **2** |
| 11 | `cdn-eu.readspeaker.com` | **44** | **44** |
| 12 | `static.addtoany.com` | **43** | **43** |
| 13 | `maps.googleapis.com` | **41** | **41** |
| 14 | `static.crisp.help` | **39** | **16** |
| 15 | `cdn.maine-et-loire.fr` | **38** | **4** |
