...
**2,641** of **87,696** available pages scanned (**3.0%** coverage)
**2,455** of **2,641** scanned pages were reachable (**93.0%**)
**1,121** reachable pages loaded at least one third-party script (**45.7%** of reachable)
**1,065** known third-party service loads identified
...
|---------|---------|-----------|-----------|------------------------|--------------------|------------------------|---------------------------|----------|
| Austria | 822 | 822 | 784 | 273 | 50 | 34.8 | 6.4 | 2026-08-10 |
| Belgium | 1,210 | 1,329 | 1,113 | 588 | 666 | 52.8 | 59.8 | 2026-08-11 |
| Bulgaria | 353 | 353 | 305 | 123 | 154 | 40.3 | 50.5 | 2026-08-10 |
| Croatia | 257 | 257 | 254 | 137 | 195 | 53.9 | 76.8 | 2026-08-11 |
...
| 1 | jsDelivr CDN | **368** |
| 2 | unpkg CDN | **203** |
| 3 | cdnjs (Cloudflare CDN) | **113** |
| 4 | Google Analytics (GA4) | **111** |
| 5 | Google Tag Manager | **61** |
| 6 | Google reCAPTCHA | **55** |
| 7 | Google Hosted Libraries | **47** |
| 8 | jQuery | **37** |
| 9 | Font Awesome | **21** |
| 10 | Cookiebot | **14** |
| 11 | Bootstrap | **12** |
...
|--:|---------|----------------:|------------------------------:|
| 1 | unpkg CDN | **199** | **78.3%** |
| 2 | jsDelivr CDN | **177** | **69.7%** |
| 3 | Google Analytics (GA4) | **109** | **42.9%** |
| 4 | cdnjs (Cloudflare CDN) | **80** | **31.5%** |
| 5 | Google Tag Manager | **61** | **24.0%** |
| 6 | Google reCAPTCHA | **54** | **21.3%** |
| 7 | Google Hosted Libraries | **46** | **18.1%** |
| 8 | jQuery | **29** | **11.4%** |
| 9 | Font Awesome | **21** | **8.3%** |
| 10 | Cookiebot | **14** | **5.5%** |
| 11 | Bootstrap | **12** | **4.7%** |
| 12 | Matomo Cloud | **11** | **4.3%** |
| 13 | Facebook Pixel | **7** | **2.8%** |
...
|--:|------|------:|----------------:|
| 1 | `prod.widgets.burgerprofiel.vlaanderen.be` | **183** | **60** |
...
| 7 | `cdntag.tarteaucitron.io` | **26** | **26** |
| 8 | `cdn.tiny.cloud` | **22** | **22** |
| 9 | `mechelen.matomo.cloud` | **20** | **20** |
| 10 | `static.addtoany.com` | **18** | **18** |
| 11 | `js.createsend1.com` | **16** | **5** |
| 12 | `d12nlb6renn3r2.cloudfront.net` | **12** | **6** |
| 13 | `wisa.cachefly.net` | **12** | **1** |
| 14 | `www.gstatic.com` | **11** | **11** |
| 15 | `maps.googleapis.com` | **11** | **11** |
