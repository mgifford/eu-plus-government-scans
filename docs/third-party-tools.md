...
_Stats as of 2026-07-21 00:53 UTC — last scan: 2026-07-20_

**7** scan batches run

**4,248** of **87,696** available pages scanned (**4.8%** coverage)
**3,982** of **4,248** scanned pages were reachable (**93.7%**)
**1,921** reachable pages loaded at least one third-party script (**48.2%** of reachable)
**2,322** known third-party service loads identified
...
|--:|---------|------:|
| 1 | jsDelivr CDN | **507** |
| 2 | Google Analytics (GA4) | **415** |
| 3 | unpkg CDN | **250** |
| 4 | Google Hosted Libraries | **221** |
| 5 | cdnjs (Cloudflare CDN) | **220** |
| 6 | Google reCAPTCHA | **216** |
| 7 | Google Tag Manager | **183** |
| 8 | jQuery | **148** |
| 9 | Font Awesome | **45** |
| 10 | Cookiebot | **28** |
| 11 | Facebook Pixel | **24** |
| 12 | Bootstrap | **23** |
| 13 | Adobe Dynamic Tag Management / Launch | **19** |
| 14 | Matomo Cloud | **8** |
| 15 | Google Analytics (Universal) | **5** |
| 16 | Cloudflare Turnstile / Challenge | **3** |
| 17 | OneTrust | **2** |
| 18 | Zendesk | **2** |
| 19 | Sentry | **2** |
| 20 | Cloudflare Web Analytics | **1** |

### Top Services by Page Prevalence

| # | Service | Reachable Pages | Prevalence of Reachable Pages |
|--:|---------|----------------:|------------------------------:|
| 1 | Google Analytics (GA4) | **410** | **107.3%** |
| 2 | jsDelivr CDN | **289** | **75.7%** |
| 3 | unpkg CDN | **231** | **60.5%** |
| 4 | Google reCAPTCHA | **212** | **55.5%** |
| 5 | Google Hosted Libraries | **202** | **52.9%** |
| 6 | Google Tag Manager | **175** | **45.8%** |
| 7 | cdnjs (Cloudflare CDN) | **172** | **45.0%** |
| 8 | jQuery | **136** | **35.6%** |
| 9 | Font Awesome | **39** | **10.2%** |
| 10 | Cookiebot | **28** | **7.3%** |
| 11 | Facebook Pixel | **24** | **6.3%** |
| 12 | Bootstrap | **23** | **6.0%** |
| 13 | Adobe Dynamic Tag Management / Launch | **19** | **5.0%** |
| 14 | Matomo Cloud | **8** | **2.1%** |
| 15 | Google Analytics (Universal) | **5** | **1.3%** |
| 16 | Cloudflare Turnstile / Challenge | **3** | **0.8%** |
| 17 | OneTrust | **2** | **0.5%** |
| 18 | Sentry | **2** | **0.5%** |
| 19 | Zendesk | **2** | **0.5%** |
| 20 | Cloudflare Web Analytics | **1** | **0.3%** |
...
|--:|------|------:|----------------:|
| 1 | `cookie-notice.plzen.eu` | **274** | **146** |
| 2 | `prod.widgets.burgerprofiel.vlaanderen.be` | **171** | **54** |
| 3 | `webcachex-eu.datareporter.eu` | **162** | **162** |
| 4 | `content.powerapps.com` | **72** | **6** |
| 5 | `translate.google.com` | **57** | **57** |
| 6 | `maps.googleapis.com` | **53** | **40** |
| 7 | `hubcdn.arcgis.com` | **45** | **9** |
| 8 | `npmcdn.com` | **41** | **41** |
| 9 | `cdn-cookieyes.com` | **36** | **36** |
| 10 | `code.highcharts.com` | **36** | **36** |
| 11 | `www.csspo.gouv.qc.ca` | **33** | **3** |
| 12 | `s7.addthis.com` | **29** | **27** |
| 13 | `static.addtoany.com` | **29** | **29** |
| 14 | `cdn.puxdesign.cz` | **28** | **4** |
| 15 | `d2i63gac8idpto.cloudfront.net` | **27** | **2** |
