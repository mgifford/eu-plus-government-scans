...
_Stats as of 2026-08-10 02:38 UTC — last scan: 2026-08-09_

**4** scan batches run

**1,775** of **87,696** available pages scanned (**2.0%** coverage)
**1,545** of **1,775** scanned pages were reachable (**87.0%**)
**631** reachable pages loaded at least one third-party script (**40.8%** of reachable)
**494** known third-party service loads identified
...
|--:|---------|------:|
| 1 | jsDelivr CDN | **144** |
| 2 | Google Analytics (GA4) | **94** |
| 3 | cdnjs (Cloudflare CDN) | **55** |
| 4 | Google reCAPTCHA | **47** |
| 5 | Google Tag Manager | **42** |
| 6 | Google Hosted Libraries | **37** |
| 7 | jQuery | **21** |
| 8 | Font Awesome | **16** |
| 9 | unpkg CDN | **12** |
| 10 | Cookiebot | **12** |
...
|--:|---------|----------------:|------------------------------:|
| 1 | Google Analytics (GA4) | **92** | **36.4%** |
| 2 | jsDelivr CDN | **79** | **31.2%** |
| 3 | Google reCAPTCHA | **47** | **18.6%** |
| 4 | Google Tag Manager | **42** | **16.6%** |
| 5 | cdnjs (Cloudflare CDN) | **41** | **16.2%** |
| 6 | Google Hosted Libraries | **36** | **14.2%** |
| 7 | jQuery | **18** | **7.1%** |
| 8 | Font Awesome | **16** | **6.3%** |
| 9 | Cookiebot | **12** | **4.7%** |
| 10 | unpkg CDN | **11** | **4.3%** |
| 11 | Facebook Pixel | **7** | **2.8%** |
| 12 | Bootstrap | **3** | **1.2%** |
| 13 | Cloudflare Turnstile / Challenge | **2** | **0.8%** |
| 14 | Google Analytics (Universal) | **1** | **0.4%** |
| 15 | Matomo Cloud | **1** | **0.4%** |
...
| 2 | `prod.widgets.burgerprofiel.vlaanderen.be` | **60** | **18** |
| 3 | `hubcdn.arcgis.com` | **30** | **6** |
| 4 | `s7.addthis.com` | **28** | **26** |
| 5 | `translate.google.com` | **25** | **25** |
| 6 | `content.powerapps.com` | **24** | **2** |
| 7 | `www.gstatic.com` | **11** | **11** |
| 8 | `api.omoguru.com` | **11** | **11** |
| 9 | `sdk.companywebcast.com` | **10** | **10** |
| 10 | `cdn.tiny.cloud` | **9** | **9** |
| 11 | `maps.google.com` | **7** | **7** |
| 12 | `maps.googleapis.com` | **7** | **7** |
| 13 | `service.bmf.gv.at` | **7** | **3** |
| 14 | `static.addtoany.com` | **7** | **7** |
| 15 | `stp.wien.gv.at` | **6** | **6** |
