...
_Stats as of 2026-05-25 03:26 UTC — last scan: 2026-05-24_

**9** scan batches run

**8,472** of **82,714** available pages scanned (**10.2%** coverage)
**8,000** of **8,472** scanned pages were reachable (**94.4%**)
**3,572** reachable pages loaded at least one third-party script (**44.6%** of reachable)
**3,918** known third-party service loads identified
**22** unique known services across **15** categories
...
| # | Service | Loads |
|--:|---------|------:|
| 1 | jsDelivr CDN | **1,020** |
| 2 | Google Analytics (GA4) | **627** |
| 3 | cdnjs (Cloudflare CDN) | **481** |
| 4 | unpkg CDN | **425** |
| 5 | Google reCAPTCHA | **341** |
| 6 | Google Tag Manager | **275** |
| 7 | Google Hosted Libraries | **247** |
| 8 | jQuery | **200** |
| 9 | Font Awesome | **81** |
| 10 | Bootstrap | **69** |
| 11 | Cookiebot | **58** |
| 12 | Facebook Pixel | **37** |
| 13 | Matomo Cloud | **14** |
| 14 | Usercentrics | **10** |
| 15 | Google Analytics (Universal) | **8** |
| 16 | Sentry | **7** |
| 17 | Cloudflare Turnstile / Challenge | **7** |
| 18 | OneTrust | **4** |
| 19 | Adobe Dynamic Tag Management / Launch | **2** |
| 20 | CookieInformation | **2** |

### Top Services by Page Prevalence

| # | Service | Reachable Pages | Prevalence of Reachable Pages |
|--:|---------|----------------:|------------------------------:|
| 1 | Google Analytics (GA4) | **621** | **45.3%** |
| 2 | jsDelivr CDN | **573** | **41.8%** |
| 3 | cdnjs (Cloudflare CDN) | **384** | **28.0%** |
| 4 | unpkg CDN | **345** | **25.2%** |
| 5 | Google reCAPTCHA | **333** | **24.3%** |
| 6 | Google Tag Manager | **268** | **19.5%** |
| 7 | Google Hosted Libraries | **231** | **16.8%** |
| 8 | jQuery | **188** | **13.7%** |
| 9 | Bootstrap | **69** | **5.0%** |
| 10 | Font Awesome | **68** | **5.0%** |
| 11 | Cookiebot | **55** | **4.0%** |
| 12 | Facebook Pixel | **37** | **2.7%** |
| 13 | Matomo Cloud | **14** | **1.0%** |
| 14 | Usercentrics | **10** | **0.7%** |
| 15 | Google Analytics (Universal) | **8** | **0.6%** |
| 16 | Cloudflare Turnstile / Challenge | **7** | **0.5%** |
| 17 | Sentry | **7** | **0.5%** |
| 18 | OneTrust | **4** | **0.3%** |
| 19 | Adobe Dynamic Tag Management / Launch | **2** | **0.1%** |
| 20 | CookieInformation | **2** | **0.1%** |
...
| 3 | `cookie-notice.plzen.eu` | **275** | **145** |
| 4 | `prod.widgets.burgerprofiel.vlaanderen.be` | **177** | **57** |
| 5 | `webcachex-eu.datareporter.eu` | **164** | **164** |
| 6 | `maps.googleapis.com` | **94** | **94** |
| 7 | `www.berlin.de` | **83** | **34** |
| 8 | `cdn.eye-able.com` | **78** | **39** |
| 9 | `translate.google.com` | **75** | **75** |
| 10 | `static.addtoany.com` | **75** | **75** |
| 11 | `cdn.userway.org` | **72** | **72** |
| 12 | `c0.wp.com` | **58** | **9** |
| 13 | `login.eduport.hamburg.de` | **54** | **54** |
| 14 | `cdn-cookieyes.com` | **53** | **53** |
