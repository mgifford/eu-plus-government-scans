...
_Stats as of 2026-08-05 15:37 UTC — last scan: 2026-08-05_

**5** scan batches run

**1,973** of **87,696** available pages scanned (**2.2%** coverage)
**1,747** of **1,973** scanned pages were reachable (**88.5%**)
**749** reachable pages loaded at least one third-party script (**42.9%** of reachable)
**679** known third-party service loads identified
...
| Belgium | 364 | 1,329 | 234 | 128 | 134 | 54.7 | 57.3 | 2026-08-05 |
| Bulgaria | 353 | 353 | 306 | 122 | 153 | 39.9 | 50.0 | 2026-08-05 |
| Canada | 178 | 4,469 | 167 | 93 | 153 | 55.7 | 91.6 | 2026-08-05 |
| Croatia | 257 | 257 | 255 | 138 | 191 | 54.1 | 74.9 | 2026-08-05 |
...
|--:|---------|------:|
| 1 | jsDelivr CDN | **190** |
| 2 | Google Analytics (GA4) | **146** |
| 3 | cdnjs (Cloudflare CDN) | **73** |
| 4 | Google reCAPTCHA | **59** |
| 5 | Google Tag Manager | **51** |
| 6 | Google Hosted Libraries | **45** |
| 7 | jQuery | **37** |
| 8 | unpkg CDN | **23** |
| 9 | Font Awesome | **17** |
| 10 | Cookiebot | **12** |
...
|--:|---------|----------------:|------------------------------:|
| 1 | Google Analytics (GA4) | **141** | **55.3%** |
| 2 | jsDelivr CDN | **113** | **44.3%** |
| 3 | Google reCAPTCHA | **59** | **23.1%** |
| 4 | cdnjs (Cloudflare CDN) | **52** | **20.4%** |
| 5 | Google Tag Manager | **51** | **20.0%** |
| 6 | Google Hosted Libraries | **44** | **17.3%** |
| 7 | jQuery | **31** | **12.2%** |
| 8 | unpkg CDN | **18** | **7.1%** |
| 9 | Font Awesome | **17** | **6.7%** |
| 10 | Cookiebot | **12** | **4.7%** |
| 11 | Adobe Dynamic Tag Management / Launch | **8** | **3.1%** |
| 12 | Facebook Pixel | **7** | **2.7%** |
| 13 | Bootstrap | **4** | **1.6%** |
| 14 | Matomo Cloud | **4** | **1.6%** |
...
| 3 | `www.csspo.gouv.qc.ca` | **33** | **3** |
| 4 | `hubcdn.arcgis.com` | **30** | **6** |
| 5 | `translate.google.com` | **28** | **28** |
| 6 | `s7.addthis.com` | **28** | **26** |
| 7 | `content.powerapps.com` | **24** | **2** |
| 8 | `maps.googleapis.com` | **16** | **16** |
| 9 | `www.canada.ca` | **12** | **6** |
| 10 | `www.gstatic.com` | **11** | **11** |
| 11 | `cdn.gtranslate.net` | **11** | **11** |
| 12 | `api.omoguru.com` | **11** | **11** |
| 13 | `maps.google.com` | **10** | **10** |
| 14 | `static.addtoany.com` | **10** | **10** |
| 15 | `sdk.companywebcast.com` | **10** | **10** |
