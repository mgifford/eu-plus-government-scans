...
_Stats as of 2026-08-08 02:46 UTC — last scan: 2026-08-07_

**6** scan batches run

**3,412** of **87,696** available pages scanned (**3.9%** coverage)
**3,151** of **3,412** scanned pages were reachable (**92.4%**)
**1,438** reachable pages loaded at least one third-party script (**45.6%** of reachable)
...
|--:|---------|------:|
| 1 | jsDelivr CDN | **329** |
| 2 | Google Analytics (GA4) | **296** |
| 3 | unpkg CDN | **187** |
| 4 | cdnjs (Cloudflare CDN) | **159** |
| 5 | Google Hosted Libraries | **151** |
| 6 | Google reCAPTCHA | **143** |
| 7 | Google Tag Manager | **134** |
| 8 | jQuery | **107** |
| 9 | Font Awesome | **31** |
| 10 | Cookiebot | **16** |
| 11 | Bootstrap | **15** |
...
|--:|---------|----------------:|------------------------------:|
| 1 | Google Analytics (GA4) | **294** | **76.4%** |
| 2 | jsDelivr CDN | **178** | **46.2%** |
| 3 | unpkg CDN | **177** | **46.0%** |
| 4 | Google Hosted Libraries | **142** | **36.9%** |
| 5 | Google reCAPTCHA | **141** | **36.6%** |
| 6 | Google Tag Manager | **134** | **34.8%** |
| 7 | cdnjs (Cloudflare CDN) | **127** | **33.0%** |
| 8 | jQuery | **99** | **25.7%** |
| 9 | Font Awesome | **28** | **7.3%** |
| 10 | Cookiebot | **16** | **4.2%** |
| 11 | Bootstrap | **15** | **3.9%** |
| 12 | Facebook Pixel | **13** | **3.4%** |
...
| 2 | `webcachex-eu.datareporter.eu` | **142** | **142** |
| 3 | `prod.widgets.burgerprofiel.vlaanderen.be` | **139** | **44** |
| 4 | `content.powerapps.com` | **48** | **4** |
| 5 | `hubcdn.arcgis.com` | **45** | **9** |
| 6 | `npmcdn.com` | **40** | **40** |
| 7 | `translate.google.com` | **39** | **39** |
| 8 | `maps.googleapis.com` | **36** | **23** |
| 9 | `code.highcharts.com` | **36** | **36** |
| 10 | `s7.addthis.com` | **30** | **28** |
| 11 | `cdntag.tarteaucitron.io` | **24** | **24** |
| 12 | `static.addtoany.com` | **23** | **23** |
| 13 | `plausible.io` | **22** | **22** |
| 14 | `cdn-cookieyes.com` | **19** | **19** |
| 15 | `js.createsend1.com` | **16** | **5** |
