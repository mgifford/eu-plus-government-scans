...
**10,604** known third-party service loads identified
...
| 2 | jsDelivr CDN | **1,979** |
| 3 | Google Analytics (GA4) | **1,647** |
| 4 | jQuery | **872** |
...
|--:|---------|----------------:|------------------------------:|
| 1 | Google Analytics (GA4) | **1,615** | **217.9%** |
| 2 | jsDelivr CDN | **1,098** | **148.2%** |
