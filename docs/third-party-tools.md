...
_Stats as of 2026-09-05 15:00 UTC — last scan: 2026-09-05_

**201** scan batches run

**50,694** of **87,696** available pages scanned (**57.8%** coverage)
**45,776** of **50,694** scanned pages were reachable (**90.3%**)
**20,676** reachable pages loaded at least one third-party script (**45.2%** of reachable)
**25,959** known third-party service loads identified
...
| France | 4,880 | 10,009 | 4,474 | 2,333 | 1,122 | 52.1 | 25.1 | 2026-09-04 |
| Germany | 5,021 | 6,599 | 4,759 | 1,233 | 972 | 25.9 | 20.4 | 2026-09-05 |
...
| Italy | 3,801 | 5,351 | 3,054 | 1,004 | 814 | 32.9 | 26.7 | 2026-09-05 |
...
| Poland | 4,728 | 14,951 | 4,325 | 2,280 | 3,589 | 52.7 | 83.0 | 2026-09-04 |
...
| Spain | 2,763 | 6,091 | 2,279 | 1,094 | 1,072 | 48.0 | 47.0 | 2026-09-04 |
| Sweden | 1,529 | 1,702 | 1,377 | 406 | 244 | 29.5 | 17.7 | 2026-08-27 |
| Switzerland | 2,123 | 2,123 | 2,067 | 408 | 447 | 19.7 | 21.6 | 2026-08-29 |
| United Kingdom | 4,830 | 19,511 | 4,524 | 2,403 | 3,382 | 53.1 | 74.8 | 2026-09-04 |
...
| # | Service | Loads |
|--:|---------|------:|
| 1 | jsDelivr CDN | **4,737** |
| 2 | Google Analytics (GA4) | **4,458** |
| 3 | cdnjs (Cloudflare CDN) | **4,408** |
| 4 | Google reCAPTCHA | **2,022** |
| 5 | Google Tag Manager | **1,993** |
| 6 | jQuery | **1,742** |
| 7 | Google Hosted Libraries | **1,618** |
| 8 | unpkg CDN | **1,589** |
| 9 | Font Awesome | **932** |
| 10 | Cookiebot | **577** |
| 11 | Bootstrap | **544** |
| 12 | CookieInformation | **423** |
| 13 | Adobe Dynamic Tag Management / Launch | **248** |
| 14 | OneTrust | **181** |
| 15 | Facebook Pixel | **168** |
| 16 | Sentry | **74** |
| 17 | Cloudflare Turnstile / Challenge | **72** |
| 18 | Google Analytics (Universal) | **45** |
| 19 | Matomo Cloud | **39** |
| 20 | Usercentrics | **34** |
...
|--:|---------|----------------:|------------------------------:|
| 1 | Google Analytics (GA4) | **4,341** | **96.0%** |
| 2 | jsDelivr CDN | **2,908** | **64.3%** |
| 3 | cdnjs (Cloudflare CDN) | **2,053** | **45.4%** |
| 4 | Google reCAPTCHA | **1,934** | **42.7%** |
| 5 | Google Tag Manager | **1,875** | **41.4%** |
| 6 | Google Hosted Libraries | **1,464** | **32.4%** |
| 7 | jQuery | **1,329** | **29.4%** |
| 8 | unpkg CDN | **1,149** | **25.4%** |
| 9 | Font Awesome | **696** | **15.4%** |
| 10 | Cookiebot | **564** | **12.5%** |
| 11 | Bootstrap | **539** | **11.9%** |
| 12 | CookieInformation | **423** | **9.4%** |
| 13 | Adobe Dynamic Tag Management / Launch | **245** | **5.4%** |
| 14 | Facebook Pixel | **163** | **3.6%** |
| 15 | OneTrust | **158** | **3.5%** |
| 16 | Cloudflare Turnstile / Challenge | **72** | **1.6%** |
| 17 | Sentry | **61** | **1.3%** |
| 18 | Google Analytics (Universal) | **45** | **1.0%** |
| 19 | Matomo Cloud | **39** | **0.9%** |
| 20 | Usercentrics | **34** | **0.8%** |
...
| 1 | CDN | **12,352** |
| 2 | Analytics | **4,974** |
| 3 | JavaScript Library | **3,360** |
| 4 | Tag Manager | **2,241** |
| 5 | Security | **2,094** |
| 6 | CAPTCHA | **2,022** |
| 7 | Cookie Consent | **1,215** |
| 8 | Icon Library | **932** |
| 9 | UI Framework | **544** |
| 10 | Advertising | **168** |
| 11 | Error Tracking | **74** |
...
|--:|------|------:|----------------:|
| 1 | `cdn.ent.auvergnerhonealpes.fr` | **10,943** | **1,182** |
| 2 | `cdn.ecollege.haute-garonne.fr` | **1,821** | **194** |
| 3 | `content.powerapps.com` | **1,096** | **91** |
| 4 | `translate.google.com` | **805** | **805** |
| 5 | `cdn.xl.pt` | **709** | **13** |
| 6 | `maps.googleapis.com` | **671** | **653** |
| 7 | `ajax.aspnetcdn.com` | **668** | **334** |
| 8 | `static.addtoany.com` | **581** | **569** |
| 9 | `assets.epexio.com` | **553** | **21** |
| 10 | `cdn-cookieyes.com` | **482** | **478** |
| 11 | `www.styleguide.sachsen.de` | **476** | **119** |
| 12 | `hubcdn.arcgis.com` | **470** | **94** |
| 13 | `cdn.datatables.net` | **468** | **165** |
| 14 | `cuatro.sim-cdn.nl` | **390** | **11** |
| 15 | `customer.cludo.com` | **351** | **265** |
