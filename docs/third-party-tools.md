...
_Stats as of 2026-08-08 18:57 UTC — last scan: 2026-08-08_

**8** scan batches run

**4,884** of **87,696** available pages scanned (**5.6%** coverage)
**4,576** of **4,884** scanned pages were reachable (**93.7%**)
**2,137** reachable pages loaded at least one third-party script (**46.7%** of reachable)
...
| # | Service | Loads |
|--:|---------|------:|
| 1 | cdnjs (Cloudflare CDN) | **1,275** |
| 2 | jsDelivr CDN | **342** |
| 3 | CookieInformation | **319** |
| 4 | Google Analytics (GA4) | **296** |
| 5 | unpkg CDN | **242** |
| 6 | Cookiebot | **170** |
| 7 | Google Hosted Libraries | **158** |
| 8 | Google reCAPTCHA | **154** |
| 9 | Google Tag Manager | **138** |
| 10 | jQuery | **122** |
| 11 | Font Awesome | **33** |
| 12 | OneTrust | **32** |
| 13 | Bootstrap | **15** |
| 14 | Facebook Pixel | **14** |
| 15 | Matomo Cloud | **6** |
...
|--:|---------|----------------:|------------------------------:|
| 1 | cdnjs (Cloudflare CDN) | **363** | **192.1%** |
| 2 | CookieInformation | **319** | **168.8%** |
| 3 | Google Analytics (GA4) | **294** | **155.6%** |
| 4 | unpkg CDN | **200** | **105.8%** |
| 5 | jsDelivr CDN | **187** | **98.9%** |
| 6 | Cookiebot | **170** | **89.9%** |
| 7 | Google reCAPTCHA | **152** | **80.4%** |
| 8 | Google Hosted Libraries | **149** | **78.8%** |
| 9 | Google Tag Manager | **138** | **73.0%** |
| 10 | jQuery | **110** | **58.2%** |
| 11 | OneTrust | **32** | **16.9%** |
| 12 | Font Awesome | **30** | **15.9%** |
| 13 | Bootstrap | **15** | **7.9%** |
| 14 | Facebook Pixel | **14** | **7.4%** |
...
|--:|----------|------:|
| 1 | CDN | **2,017** |
| 2 | Cookie Consent | **521** |
| 3 | Analytics | **322** |
| 4 | JavaScript Library | **280** |
| 5 | Security | **156** |
| 6 | CAPTCHA | **154** |
| 7 | Tag Manager | **139** |
| 8 | Icon Library | **33** |
...
| 11 | `analytics.silktide.com` | **115** | **113** |
| 12 | `siteimproveanalytics.com` | **70** | **70** |
| 13 | `app-script.monsido.com` | **69** | **69** |
| 14 | `maps.googleapis.com` | **48** | **35** |
| 15 | `content.powerapps.com` | **48** | **4** |
