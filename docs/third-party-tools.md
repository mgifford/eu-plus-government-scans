...
_Stats as of 2026-06-02 05:41 UTC — last scan: 2026-06-01_

**50** scan batches run

**23,043** of **82,714** available pages scanned (**27.9%** coverage)
**21,173** of **23,043** scanned pages were reachable (**91.9%**)
**10,162** reachable pages loaded at least one third-party script (**48.0%** of reachable)
**13,609** known third-party service loads identified
...
| Netherlands | 574 | 937 | 550 | 216 | 161 | 39.3 | 29.3 | 2026-05-27 |
| Norway | 239 | 239 | 233 | 131 | 110 | 56.2 | 47.2 | 2026-05-27 |
...
| # | Service | Loads |
|--:|---------|------:|
| 1 | jsDelivr CDN | **2,892** |
| 2 | cdnjs (Cloudflare CDN) | **2,577** |
| 3 | Google Analytics (GA4) | **1,977** |
| 4 | jQuery | **1,063** |
| 5 | Google reCAPTCHA | **1,021** |
| 6 | unpkg CDN | **875** |
| 7 | Google Tag Manager | **827** |
| 8 | Google Hosted Libraries | **666** |
...
|--:|---------|----------------:|------------------------------:|
| 1 | Google Analytics (GA4) | **1,938** | **412.3%** |
| 2 | jsDelivr CDN | **1,714** | **364.7%** |
| 3 | cdnjs (Cloudflare CDN) | **1,161** | **247.0%** |
| 4 | Google reCAPTCHA | **995** | **211.7%** |
| 5 | Google Tag Manager | **799** | **170.0%** |
| 6 | jQuery | **760** | **161.7%** |
| 7 | unpkg CDN | **634** | **134.9%** |
| 8 | Google Hosted Libraries | **589** | **125.3%** |
| 9 | CookieInformation | **446** | **94.9%** |
| 10 | Cookiebot | **412** | **87.7%** |
| 11 | Font Awesome | **228** | **48.5%** |
...
| 4 | Security | **1,059** |
| 5 | CAPTCHA | **1,021** |
| 6 | Cookie Consent | **973** |
| 7 | Tag Manager | **859** |
| 8 | Icon Library | **285** |
| 9 | UI Framework | **215** |
| 10 | Advertising | **78** |
| 11 | Error Tracking | **26** |
...
| 9 | `www.youtube.com` | **278** | **278** |
| 10 | `cookie-notice.plzen.eu` | **276** | **146** |
| 11 | `cdn.datatables.net` | **263** | **86** |
| 12 | `cm-ob.pt` | **249** | **17** |
| 13 | `dreambroker.com` | **245** | **245** |
| 14 | `cdn.herning.dk` | **238** | **24** |
| 15 | `static.parastorage.com` | **208** | **19** |
