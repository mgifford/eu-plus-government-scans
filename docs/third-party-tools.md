...
**10,541** known third-party service loads identified
...
| # | Service | Loads |
|--:|---------|------:|
| 1 | cdnjs (Cloudflare CDN) | **2,138** |
| 2 | jsDelivr CDN | **2,029** |
...
| 3 | cdnjs (Cloudflare CDN) | **806** | **250.3%** |
