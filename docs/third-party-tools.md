...
**1,925** of **82,714** available pages scanned (**2.3%** coverage)
**1,695** of **1,925** scanned pages were reachable (**88.1%**)
**702** reachable pages loaded at least one third-party script (**41.4%** of reachable)
**484** known third-party service loads identified
...
|--:|---------|------:|
| 1 | jsDelivr CDN | **151** |
| 2 | Google Analytics (GA4) | **87** |
| 3 | cdnjs (Cloudflare CDN) | **50** |
| 4 | Google reCAPTCHA | **41** |
| 5 | Google Hosted Libraries | **39** |
| 6 | Google Tag Manager | **27** |
| 7 | unpkg CDN | **23** |
| 8 | jQuery | **20** |
| 9 | Font Awesome | **15** |
| 10 | Cookiebot | **13** |
...
|--:|---------|----------------:|------------------------------:|
| 1 | Google Analytics (GA4) | **85** | **41.7%** |
| 2 | jsDelivr CDN | **80** | **39.2%** |
| 3 | Google reCAPTCHA | **41** | **20.1%** |
| 4 | cdnjs (Cloudflare CDN) | **39** | **19.1%** |
| 5 | Google Hosted Libraries | **37** | **18.1%** |
| 6 | Google Tag Manager | **27** | **13.2%** |
| 7 | jQuery | **18** | **8.8%** |
| 8 | unpkg CDN | **18** | **8.8%** |
| 9 | Font Awesome | **15** | **7.4%** |
| 10 | Cookiebot | **13** | **6.4%** |
| 11 | Facebook Pixel | **7** | **3.4%** |
| 12 | Bootstrap | **5** | **2.5%** |
| 13 | Matomo Cloud | **4** | **2.0%** |
| 14 | Cloudflare Turnstile / Challenge | **2** | **1.0%** |
...
| 4 | `prod.widgets.burgerprofiel.vlaanderen.be` | **57** | **17** |
| 5 | `static.crisp.help` | **39** | **16** |
| 6 | `hubcdn.arcgis.com` | **30** | **6** |
| 7 | `s7.addthis.com` | **28** | **26** |
| 8 | `translate.google.com` | **24** | **24** |
| 9 | `content.powerapps.com` | **24** | **2** |
| 10 | `cdntag.tarteaucitron.io` | **10** | **10** |
| 11 | `api.omoguru.com` | **10** | **10** |
| 12 | `sdk.companywebcast.com` | **10** | **10** |
| 13 | `www.gstatic.com` | **9** | **9** |
| 14 | `stats.wp.com` | **9** | **9** |
| 15 | `cdn.tiny.cloud` | **9** | **9** |
