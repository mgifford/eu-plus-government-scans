...
_Stats as of 2026-08-09 02:34 UTC — last scan: 2026-08-08_

**11** scan batches run

**6,408** of **87,696** available pages scanned (**7.3%** coverage)
**5,937** of **6,408** scanned pages were reachable (**92.6%**)
**2,867** reachable pages loaded at least one third-party script (**48.3%** of reachable)
**4,770** known third-party service loads identified
...
| Canada | 596 | 4,469 | 569 | 335 | 496 | 58.9 | 87.2 | 2026-08-08 |
| Croatia | 257 | 257 | 253 | 136 | 195 | 53.8 | 77.1 | 2026-08-07 |
| Czechia | 672 | 866 | 618 | 338 | 599 | 54.7 | 96.9 | 2026-08-07 |
| Denmark | 1,273 | 1,536 | 1,236 | 653 | 1,705 | 52.8 | 137.9 | 2026-08-08 |
| Estonia | 401 | 401 | 385 | 135 | 115 | 35.1 | 29.9 | 2026-08-07 |
| Finland | 199 | 199 | 189 | 46 | 26 | 24.3 | 13.8 | 2026-08-08 |
| Hungary | 392 | 392 | 293 | 125 | 193 | 42.7 | 65.9 | 2026-08-08 |
| Ireland | 536 | 536 | 499 | 270 | 752 | 54.1 | 150.7 | 2026-08-08 |
...
| # | Service | Loads |
|--:|---------|------:|
| 1 | cdnjs (Cloudflare CDN) | **1,403** |
| 2 | jsDelivr CDN | **776** |
| 3 | Google Analytics (GA4) | **518** |
| 4 | CookieInformation | **319** |
| 5 | Google Hosted Libraries | **295** |
| 6 | unpkg CDN | **295** |
| 7 | Google reCAPTCHA | **260** |
| 8 | Google Tag Manager | **231** |
| 9 | Cookiebot | **228** |
| 10 | jQuery | **218** |
| 11 | Font Awesome | **59** |
| 12 | OneTrust | **59** |
...
| 16 | Google Analytics (Universal) | **8** |
| 17 | Sentry | **8** |
| 18 | Matomo Cloud | **6** |
...
|--:|---------|----------------:|------------------------------:|
| 1 | Google Analytics (GA4) | **513** | **102.8%** |
| 2 | cdnjs (Cloudflare CDN) | **449** | **90.0%** |
| 3 | jsDelivr CDN | **327** | **65.5%** |
| 4 | CookieInformation | **319** | **63.9%** |
| 5 | Google Hosted Libraries | **270** | **54.1%** |
| 6 | Google reCAPTCHA | **250** | **50.1%** |
| 7 | unpkg CDN | **237** | **47.5%** |
| 8 | Google Tag Manager | **230** | **46.1%** |
| 9 | Cookiebot | **226** | **45.3%** |
| 10 | jQuery | **187** | **37.5%** |
| 11 | OneTrust | **56** | **11.2%** |
| 12 | Font Awesome | **48** | **9.6%** |
| 13 | Bootstrap | **34** | **6.8%** |
| 14 | Adobe Dynamic Tag Management / Launch | **22** | **4.4%** |
| 15 | Facebook Pixel | **16** | **3.2%** |
| 16 | Google Analytics (Universal) | **8** | **1.6%** |
| 17 | Sentry | **8** | **1.6%** |
...
|--:|----------|------:|
| 1 | CDN | **2,769** |
| 2 | Cookie Consent | **606** |
| 3 | Analytics | **571** |
| 4 | JavaScript Library | **513** |
| 5 | Security | **265** |
| 6 | CAPTCHA | **260** |
| 7 | Tag Manager | **253** |
| 8 | Icon Library | **59** |
...
|--:|------|------:|----------------:|
| 1 | `ajax.aspnetcdn.com` | **465** | **230** |
| 2 | `customer.cludo.com` | **270** | **210** |
| 3 | `dreambroker.com` | **214** | **214** |
| 4 | `cookie-notice.plzen.eu` | **206** | **111** |
| 5 | `cdn.herning.dk` | **188** | **20** |
| 6 | `cdn1.gopublic.dk` | **171** | **18** |
| 7 | `cdn.hjoerring.dk` | **164** | **15** |
| 8 | `webcachex-eu.datareporter.eu` | **142** | **142** |
| 9 | `prod.widgets.burgerprofiel.vlaanderen.be` | **139** | **44** |
| 10 | `consent.cookiebot.eu` | **134** | **134** |
| 11 | `content.powerapps.com` | **132** | **11** |
| 12 | `analytics.silktide.com` | **115** | **113** |
| 13 | `maps.googleapis.com` | **83** | **70** |
| 14 | `static.parastorage.com` | **80** | **8** |
| 15 | `siteimproveanalytics.com` | **70** | **70** |
