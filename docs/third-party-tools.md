...
| # | Service | Loads |
|--:|---------|------:|
| 1 | cdnjs (Cloudflare CDN) | **2,084** |
| 2 | jsDelivr CDN | **1,940** |
| 3 | Google Analytics (GA4) | **1,605** |
| 4 | jQuery | **863** |
...
|--:|---------|----------------:|------------------------------:|
| 1 | Google Analytics (GA4) | **1,578** | **213.0%** |
| 2 | jsDelivr CDN | **1,065** | **143.7%** |
| 3 | cdnjs (Cloudflare CDN) | **777** | **104.9%** |
