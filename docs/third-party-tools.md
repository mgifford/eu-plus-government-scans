...
**7,486** reachable pages loaded at least one third-party script (**46.9%** of reachable)
...
|--:|---------|----------------:|------------------------------:|
| 1 | Google Analytics (GA4) | **1,592** | **214.8%** |
