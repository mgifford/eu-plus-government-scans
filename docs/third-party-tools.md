...
**1,093** of **1,175** scanned pages were reachable (**93.0%**)
**391** reachable pages loaded at least one third-party script (**35.8%** of reachable)
...
|---------|---------|-----------|-----------|------------------------|--------------------|------------------------|---------------------------|----------|
| Austria | 822 | 822 | 787 | 269 | 50 | 34.2 | 6.4 | 2026-08-04 |
| Bulgaria | 353 | 353 | 306 | 122 | 153 | 39.9 | 50.0 | 2026-08-04 |
...
| 3 | jsDelivr CDN | **26** | **8.5%** |
| 4 | Google Hosted Libraries | **25** | **8.2%** |
| 5 | cdnjs (Cloudflare CDN) | **24** | **7.8%** |
| 6 | jQuery | **12** | **3.9%** |
